...
class FuncionesController extends Controller
{
    ...
    //Obtén la información detallada de los pedidos, incluyendo el nombre y correo
    ...
    //Recupera todos los pedidos junto con la información de los usuarios, ordenándolos
    ...
    public function pedidoEconomico(){
        ...
        */
        //se usa una subconsulta para obtener el valor del pedido mas economico
        $data = Pedidos::join('usuarios', 'pedidos.id_usuario', '=', 'usuarios.id')
        ->select(
    ...
    public function pedidosUsuario(){
        ...
        */
        //esta fue la unica forma que logre para agrupar segun el id del usuario
